...
abstract final class ToolReferenceData {
  ...
  static const errorCodes = [
    ('-1', 'Unknown error', 'Restart 3uTools and your computer. Try a different USB cable and port.'),
    ...
    ('11', 'Corrupt firmware', 'Download a fresh IPSW from ipsw.me or use 3uTools download.'),
    ...
    ('27', 'iTunes sync error', 'Disable iTunes auto-sync and close iTunes before using 3uTools.'),
    ...
    ('50', 'File permission error', 'Run 3uTools as administrator (Windows) or check folder permissions.'),
  ...
  static const dfuSteps = [
    (
      'Connect to Computer',
      'Plug your iPhone into your Mac or PC with a USB cable. Open 3uTools.',
    ),
    (
      'Press Volume Up',
    ...
    (
      'Screen Stays Black',
      'If successful, the screen remains black but 3uTools detects DFU mode. You can now flash firmware.',
    ),
  ];

  static const backupChecklist = [
    'iPhone is connected and recognized by 3uTools',
    ...
    'Previous backup date is visible in 3uTools',
